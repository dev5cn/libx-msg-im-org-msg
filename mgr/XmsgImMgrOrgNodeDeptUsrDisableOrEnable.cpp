...
#include "XmsgImMgrOrgNodeDeptUsrDisableOrEnable.h"

XmsgImMgrOrgNodeDeptUsrDisableOrEnable::XmsgImMgrOrgNodeDeptUsrDisableOrEnable()
{

}

void XmsgImMgrOrgNodeDeptUsrDisableOrEnable::handle(shared_ptr<XmsgNeUsr> nu, SptrXitp trans, shared_ptr<XmsgImMgrOrgNodeDeptUsrDisableOrEnableReq> req)
{
	if (req->dcgt().empty())
	{
	...
	{
		XmsgImMgrOrgNodeDeptUsrDisableOrEnable::update2db(trans, req, dcgt, ucgt);
	});
}

void XmsgImMgrOrgNodeDeptUsrDisableOrEnable::update2db(SptrXitp trans, shared_ptr<XmsgImMgrOrgNodeDeptUsrDisableOrEnableReq> req, SptrCgt dcgt, SptrCgt ucgt)
{
